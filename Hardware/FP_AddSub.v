...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV GX" DIRECTION="VARIABLE" OPTIMIZE="AREA" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr add_sub clock dataa datab result
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FP_AddSub_altfp_add_sub_ork
	( 
	aclr,
	add_sub,
	clock,
...
endmodule //FP_AddSub_altfp_add_sub_ork
//VALID FILE
...
module FP_AddSub (
	...
	FP_AddSub_altfp_add_sub_ork	FP_AddSub_altfp_add_sub_ork_component (
				.aclr (aclr),
				.add_sub (add_sub),
				.clock (clock),
				.dataa (dataa),
