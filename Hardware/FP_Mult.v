...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone IV GX" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clock dataa datab result
...
endmodule //FP_Mult_altfp_mult_pdo
//VALID FILE
...
module FP_Mult (
	...
	FP_Mult_altfp_mult_pdo	FP_Mult_altfp_mult_pdo_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
