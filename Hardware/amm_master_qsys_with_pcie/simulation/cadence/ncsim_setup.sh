...
mkdir -p ./libraries/User_Module_0_avalon_master_agent/
mkdir -p ./libraries/sdram_s1_translator/
mkdir -p ./libraries/User_Module_0_avalon_master_translator/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter_001_error_adapter_0.sv" -work error_adapter_0                            -cdslib ./cds_libs/error_adapter_0.cds.lib                           
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"     -work error_adapter_0                            -cdslib ./cds_libs/error_adapter_0.cds.lib                           
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_router_001.sv"                            -work router_001                                 -cdslib ./cds_libs/router_001.cds.lib                                
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter_001.v"                  -work avalon_st_adapter_001                      -cdslib ./cds_libs/avalon_st_adapter_001.cds.lib                     
  ncvlog     "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter.v"                      -work avalon_st_adapter                          -cdslib ./cds_libs/avalon_st_adapter.cds.lib                         
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                                       -work sgdma_m_read_to_sdram_s1_cmd_width_adapter -cdslib ./cds_libs/sgdma_m_read_to_sdram_s1_cmd_width_adapter.cds.lib
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                                   -work sgdma_m_read_to_sdram_s1_cmd_width_adapter -cdslib ./cds_libs/sgdma_m_read_to_sdram_s1_cmd_width_adapter.cds.lib
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                                  -work sgdma_m_read_to_sdram_s1_cmd_width_adapter -cdslib ./cds_libs/sgdma_m_read_to_sdram_s1_cmd_width_adapter.cds.lib
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                          -work rsp_mux_001                                -cdslib ./cds_libs/rsp_mux_001.cds.lib                               
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_rsp_mux_001.sv"                           -work rsp_mux_001                                -cdslib ./cds_libs/rsp_mux_001.cds.lib                               
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                          -work rsp_mux                                    -cdslib ./cds_libs/rsp_mux.cds.lib                                   
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_rsp_demux_001.sv"                         -work rsp_demux_001                              -cdslib ./cds_libs/rsp_demux_001.cds.lib                             
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_mux_001.sv"                           -work cmd_mux_001                                -cdslib ./cds_libs/cmd_mux_001.cds.lib                               
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                          -work cmd_mux                                    -cdslib ./cds_libs/cmd_mux.cds.lib                                   
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_demux_003.sv"                         -work cmd_demux_003                              -cdslib ./cds_libs/cmd_demux_003.cds.lib                             
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_demux_002.sv"                         -work cmd_demux_002                              -cdslib ./cds_libs/cmd_demux_002.cds.lib                             
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_demux_001.sv"                         -work cmd_demux_001                              -cdslib ./cds_libs/cmd_demux_001.cds.lib                             
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                                     -work sgdma_m_read_limiter                       -cdslib ./cds_libs/sgdma_m_read_limiter.cds.lib                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                                      -work sgdma_m_read_limiter                       -cdslib ./cds_libs/sgdma_m_read_limiter.cds.lib                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                              -work sgdma_m_read_limiter                       -cdslib ./cds_libs/sgdma_m_read_limiter.cds.lib                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                                     -work sgdma_m_read_limiter                       -cdslib ./cds_libs/sgdma_m_read_limiter.cds.lib                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_006.sv"                            -work router_006                                 -cdslib ./cds_libs/router_006.cds.lib                                
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_005.sv"                            -work router_005                                 -cdslib ./cds_libs/router_005.cds.lib                                
  ncvlog -sv "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_003.sv"                            -work router_003                                 -cdslib ./cds_libs/router_003.cds.lib                                
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                                        -work User_Module_0_avalon_master_agent          -cdslib ./cds_libs/User_Module_0_avalon_master_agent.cds.lib         
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                                   -work User_Module_0_avalon_master_translator     -cdslib ./cds_libs/User_Module_0_avalon_master_translator.cds.lib    
