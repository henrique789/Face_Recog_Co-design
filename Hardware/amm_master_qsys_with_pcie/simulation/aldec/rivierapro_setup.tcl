...
alias dev_com {
  ...
  vlog -v2k5 "$QUARTUS_INSTALL_DIR/eda/sim_lib/cycloneiv_hssi_atoms.v"     -work cycloneiv_hssi_ver    
  vlog -v2k5 "$QUARTUS_INSTALL_DIR/eda/sim_lib/cycloneiv_pcie_hip_atoms.v" -work cycloneiv_pcie_hip_ver
  vlog -v2k5 "$QUARTUS_INSTALL_DIR/eda/sim_lib/cycloneiv_atoms.v"          -work cycloneiv_ver         
}
...
alias com {
  echo "\[exec\] com"
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter_001_error_adapter_0.sv" -work error_adapter_0                           
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"     -work error_adapter_0                           
  ...
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_router_001.sv"                            -work router_001                                
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1_router.sv"                                -work router                                    
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter_001.v"                  -work avalon_st_adapter_001                     
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_avalon_st_adapter.v"                      -work avalon_st_adapter                         
  ...
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                                       -work sgdma_m_read_to_sdram_s1_cmd_width_adapter
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                                   -work sgdma_m_read_to_sdram_s1_cmd_width_adapter
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                                  -work sgdma_m_read_to_sdram_s1_cmd_width_adapter
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                          -work rsp_mux_001                               
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_rsp_mux_001.sv"                           -work rsp_mux_001                               
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                          -work rsp_mux                                   
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_rsp_mux.sv"                               -work rsp_mux                                   
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_rsp_demux_001.sv"                         -work rsp_demux_001                             
  ...
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_mux_001.sv"                           -work cmd_mux_001                               
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                          -work cmd_mux                                   
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_mux.sv"                               -work cmd_mux                                   
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_demux_003.sv"                         -work cmd_demux_003                             
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_demux_002.sv"                         -work cmd_demux_002                             
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_cmd_demux_001.sv"                         -work cmd_demux_001                             
  ...
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                                     -work sgdma_m_read_limiter                      
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                                      -work sgdma_m_read_limiter                      
  vlog       "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                              -work sgdma_m_read_limiter                      
  vlog       "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                                     -work sgdma_m_read_limiter                      
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_006.sv"                            -work router_006                                
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_005.sv"                            -work router_005                                
  vlog       "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0_router_003.sv"                            -work router_003                                
  ...
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                                         -work sdram_s1_agent                            
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                                  -work sdram_s1_agent                            
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                                        -work User_Module_0_avalon_master_agent         
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                                    -work sdram_s1_translator                       
  vlog       "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                                   -work User_Module_0_avalon_master_translator    
  vlog -v2k5 "$QSYS_SIMDIR/submodules/altpcie_pipe_interface.v"                                                             -work pipe_interface_internal                   
  vlog -v2k5 "$QSYS_SIMDIR/submodules/altpcie_pcie_reconfig_bridge.v"                                                       -work pipe_interface_internal                   
  vlog -v2k5 "$QSYS_SIMDIR/submodules/altera_pcie_hard_ip_reset_controller.v"                                               -work reset_controller_internal                 
  vlog -v2k5 "$QSYS_SIMDIR/submodules/altpcie_rs_serdes.v"                                                                  -work reset_controller_internal                 
  vlog -v2k5 "$QSYS_SIMDIR/submodules/altpcie_pll_100_250.v"                                                                -work reset_controller_internal                 
  vlog -v2k5 "$QSYS_SIMDIR/submodules/altpcie_pll_125_250.v"                                                                -work reset_controller_internal                 
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_pcie_ip_altgx_internal.vo"                                  -work altgx_internal                            
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_a2p_addrtrans.v"                                   -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_a2p_fixtrans.v"                                    -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_a2p_vartrans.v"                                    -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_control_register.v"                                -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_cfg_status.v"                                      -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_cr_avalon.v"                                       -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_cr_interrupt.v"                                    -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_cr_mailbox.v"                                      -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_p2a_addrtrans.v"                                   -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_reg_fifo.v"                                        -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_rx.v"                                              -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_rx_cntrl.v"                                        -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_rx_resp.v"                                         -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_tx.v"                                              -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_tx_cntrl.v"                                        -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_txavl_cntrl.v"                                     -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_stif_txresp_cntrl.v"                                    -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_stif/altpciexpav_clksync.v"                                              -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/aldec/avalon_lite/altpciexpav_lite_app.v"                                             -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/altpciexpav_stif_app.v"                                                               -work pcie_internal_hip                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/altpcie_hip_pipen1b_qsys.v"                                                           -work pcie_internal_hip                         
  ...
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_2.v"                                        -work mm_interconnect_2                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_1.v"                                        -work mm_interconnect_1                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_mm_interconnect_0.v"                                        -work mm_interconnect_0                         
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_sgdma.v"                                                    -work sgdma                                     
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_sdram.v"                                                    -work sdram                                     
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_pcie_ip.v"                                                  -work pcie_ip                                   
  vlog -v2k5 "$QSYS_SIMDIR/submodules/amm_master_qsys_with_pcie_altpll_qsys.vo"                                             -work altpll_qsys                               
  vlog       "$QSYS_SIMDIR/submodules/user_module.sv"                                                                       -work User_Module_0                             
  vlog -v2k5 "$QSYS_SIMDIR/amm_master_qsys_with_pcie.v"                                                                                                                     
}
