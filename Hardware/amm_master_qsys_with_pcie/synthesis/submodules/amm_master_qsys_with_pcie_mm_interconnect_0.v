...
module amm_master_qsys_with_pcie_mm_interconnect_0 (
		...
		input  wire [31:0] User_Module_0_avalon_master_address,                      //                        User_Module_0_avalon_master.address
	...
	wire          rsp_mux_src_valid;                                                              // rsp_mux:src_valid -> User_Module_0_avalon_master_agent:rp_valid
	wire  [113:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> User_Module_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                              // User_Module_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [4:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> User_Module_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                      // rsp_mux:src_startofpacket -> User_Module_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                        // rsp_mux:src_endofpacket -> User_Module_0_avalon_master_agent:rp_endofpacket
	...
	wire          user_module_0_avalon_master_agent_cp_valid;                                     // User_Module_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [113:0] user_module_0_avalon_master_agent_cp_data;                                      // User_Module_0_avalon_master_agent:cp_data -> router:sink_data
	wire          user_module_0_avalon_master_agent_cp_ready;                                     // router:sink_ready -> User_Module_0_avalon_master_agent:cp_ready
	wire          user_module_0_avalon_master_agent_cp_startofpacket;                             // User_Module_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          user_module_0_avalon_master_agent_cp_endofpacket;                               // User_Module_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
